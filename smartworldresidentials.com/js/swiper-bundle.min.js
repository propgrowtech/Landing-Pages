! function(e, t) {
        ...
        for (var e = Object(arguments.length <= 0 ? void 0 : arguments[0]), t = 1; t < arguments.length; t += 1) {
            ...
            if (null != a)
                for (var i = Object.keys(Object(a)), s = 0, r = i.length; s < r; s += 1) {
                    ...
                    void 0 !== l && l.enumerable && (T(e[n]) && T(a[n]) ? C(e[n], a[n]) : !T(e[n]) && T(a[n]) ? (e[n] = {}, C(e[n], a[n])) : e[n] = a[n])
                }
        }
        return e
    }
    ...
    var G = {
            ...
            update: {
                ...
                updateSlides: function() {
                    ...
                    if (void 0 !== s) {
                        ...
                        for (var z, P = a.slidesPerColumn, k = S / P, L = Math.floor(u / a.slidesPerColumn), $ = 0; $ < u; $ += 1) {
                            M = 0;
                            var I = p.eq($);
                            if (a.slidesPerColumn > 1) {
                                ...
                                if ("row" === a.slidesPerColumnFill && a.slidesPerGroup > 1) {
                                    ...
                                    O = (A = N - (D = Math.floor(N / B)) * B + G * a.slidesPerGroup) + D * S / P, I.css({
                        ...
                        if (e.virtualSize = Math.max(e.virtualSize, s) + g, r && n && ("slide" === a.effect || "coverflow" === a.effect) && i.css({
                            ...
                            })), a.slidesPerColumn > 1 && (e.virtualSize = (M + a.spaceBetween) * S, e.virtualSize = Math.ceil(e.virtualSize / a.slidesPerColumn) - a.spaceBetween, e.isHorizontal() ? i.css({
                                width: e.virtualSize + a.spaceBetween + "px"
                            }) : i.css({
                                height: e.virtualSize + a.spaceBetween + "px"
                            }), a.centeredSlides)) {
                ...
                updateClickedSlide: function(e) {
                    var t = this,
                        a = t.params,
                        i = f(e.target).closest("." + a.slideClass)[0],
                        s = !1;
                    if (i)
                        for (var r = 0; r < t.slides.length; r += 1) t.slides[r] === i && (s = !0);
                    if (!i || !s) return t.clickedSlide = void 0, void(t.clickedIndex = void 0);
                    t.clickedSlide = i, t.virtual && t.params.virtual.enabled ? t.clickedIndex = parseInt(f(i).attr("data-swiper-slide-index"), 10) : t.clickedIndex = f(i).index(), a.slideToClickedSlide && void 0 !== t.clickedIndex && t.clickedIndex !== t.activeIndex && t.slideToClickedSlide()
                }
            },
            translate: {
            ...
            slide: {
                slideTo: function(e, t, a, i) {
                    ...
                    if (l.cssMode) {
                        var w, b = r.isHorizontal(),
                            E = -g;
                        return c && (E = h.scrollWidth - h.offsetWidth - E), 0 === t ? h[b ? "scrollLeft" : "scrollTop"] = E : h.scrollTo ? h.scrollTo(((w = {})[b ? "left" : "top"] = E, w.behavior = "smooth", w)) : h[b ? "scrollLeft" : "scrollTop"] = E, !0
                    }
                ...
                slideToClickedSlide: function() {
                    ...
                    if (a.loop) {
                        ...
                        e = parseInt(f(t.clickedSlide).attr("data-swiper-slide-index"), 10), a.centeredSlides ? r < t.loopedSlides - s / 2 || r > t.slides.length - t.loopedSlides + s / 2 ? (t.loopFix(), r = i.children("." + a.slideClass + '[data-swiper-slide-index="' + e + '"]:not(.' + a.slideDuplicateClass + ")").eq(0).index(), b(function() {
                            t.slideTo(r)
                        })) : t.slideTo(r) : r > t.slides.length - s ? (t.loopFix(), r = i.children("." + a.slideClass + '[data-swiper-slide-index="' + e + '"]:not(.' + a.slideDuplicateClass + ")").eq(0).index(), b(function() {
                            t.slideTo(r)
                        })) : t.slideTo(r)
                    } else t.slideTo(r)
                }
            ...
            events: {
                attachEvents: function() {
                    var e = this,
                        ...
                        l = e.device,
                        o = e.support;
                    e.onTouchStart = I.bind(e), e.onTouchMove = function(e) {
                        var t = r(),
                            a = this,
                            i = a.touchEventsData,
                            s = a.params,
                        ...
                        if (t.allowClick && (t.updateClickedSlide(d), t.emit("tap click", d), c < 300 && u - a.lastClickTime < 300 && t.emit("doubleTap doubleClick", d)), a.lastClickTime = E(), b(function() {
                        ...
                        if (a.isTouched = !1, a.isMoved = !1, a.startMoving = !1, p = i.followFinger ? r ? t.translate : -t.translate : -a.currentTranslate, !i.cssMode)
                            if (i.freeMode) {
                                ...
                                if (i.freeModeMomentum) {
                                    ...
                                    if (w < t.maxTranslate()) i.freeModeMomentumBounce ? (w + t.maxTranslate() < -S && (w = t.maxTranslate() - S), x = t.maxTranslate(), C = !0, a.allowMomentumBounce = !0) : w = t.maxTranslate(), i.loop && i.centeredSlides && (T = !0);
                                    else if (w > t.minTranslate()) i.freeModeMomentumBounce ? (w - t.minTranslate() > S && (w = t.minTranslate() + S), x = t.minTranslate(), C = !0, a.allowMomentumBounce = !0) : w = t.minTranslate(), i.loop && i.centeredSlides && (T = !0);
                                    ...
                                    i.freeModeMomentumBounce && C ? (t.updateProgress(x), t.setTransition(g), t.setTranslate(w), t.transitionStart(!0, t.swipeDirection), t.animating = !0, n.transitionEnd(function() {
                    ...
                    if (!o.touch && o.pointerEvents) s.addEventListener(i.start, e.onTouchStart, !1), t.addEventListener(i.move, e.onTouchMove, d), t.addEventListener(i.end, e.onTouchEnd, !1);
                        ...
                        if (o.touch) {
                            ...
                            s.addEventListener(i.start, e.onTouchStart, p), s.addEventListener(i.move, e.onTouchMove, o.passiveListener ? {
                                passive: !1,
                                capture: d
                            } : d), s.addEventListener(i.end, e.onTouchEnd, p), i.cancel && s.addEventListener(i.cancel, e.onTouchEnd, p), A || (t.addEventListener("touchstart", D), A = !0)
                        }(a.simulateTouch && !l.ios && !l.android || a.simulateTouch && !o.touch && l.ios) && (s.addEventListener("mousedown", e.onTouchStart, !1), t.addEventListener("mousemove", e.onTouchMove, d), t.addEventListener("mouseup", e.onTouchEnd, !1))
                    }(a.preventClicks || a.preventClicksPropagation) && s.addEventListener("click", e.onClick, !0), a.cssMode && n.addEventListener("scroll", e.onScroll), a.updateOnWindowResize ? e.on(l.ios || l.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", O, !0) : e.on("observerUpdate", O, !0)
                },
                detachEvents: function() {
                    ...
                    }(a.preventClicks || a.preventClicksPropagation) && s.removeEventListener("click", e.onClick, !0), a.cssMode && n.removeEventListener("scroll", e.onScroll), e.off(l.ios || l.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", O)
                }
            },
            breakpoints: {
        ...
        H = function() {
            function t() {
                ...
                1 === s.length && s[0].constructor && s[0].constructor === Object ? a = s[0] : (e = s[0], a = s[1]), a || (a = {}), a = C({}, a), e && !a.el && (a.el = e);
                var n = this;
                n.support = M(), n.device = z({
                    userAgent: a.userAgent
                }), n.browser = P(), n.eventsListeners = {}, n.eventsAnyListeners = [], void 0 === n.modules && (n.modules = {}), Object.keys(n.modules).forEach(function(e) {
                    var t = n.modules[e];
                    if (t.params) {
                ...
                var l = C({}, G);
                n.useParams(l), n.params = C({}, l, B, a), n.originalParams = C({}, n.params), n.passedParams = C({}, a), n.params && n.params.on && Object.keys(n.params.on).forEach(function(e) {
                ...
                if (e = o[0]) {
                    ...
                    var p, u, c;
                    return e.swiper = n, e && e.shadowRoot && e.shadowRoot.querySelector ? (p = f(e.shadowRoot.querySelector("." + n.params.wrapperClass))).children = function(e) {
                        return o.children(e)
                    } : p = o.children("." + n.params.wrapperClass), C(n, {
                        $el: o,
                        el: e,
                        $wrapperEl: p,
                        wrapperEl: p[0],
    ...
    var X = {
            update: function(e) {
                ...
                for (var P = 0; P < c.length; P += 1) P >= b && P <= E && (void 0 === u || e ? M.push(P) : (P > u && M.push(P), P < p && S.push(P)));
                    ...
                    if (!u) {
                        ...
                        if (c >= a.minTranslate() && (c = a.minTranslate()), c <= a.maxTranslate() && (c = a.maxTranslate()), a.setTransition(0), a.setTranslate(c), a.updateProgress(), a.updateActiveIndex(), a.updateSlidesClasses(), (!h && a.isBeginning || !v && a.isEnd) && a.updateSlidesClasses(), a.params.freeModeSticky) {
                            ...
                            if (m.push(d), g && (d.delta > g.delta || d.direction !== g.direction)) m.splice(0);
                                ...
                                var w = r > 0 ? .8 : .2;
                                a.mousewheel.lastEventBeforeSnap = d, m.splice(0), a.mousewheel.timeout = b(function() {
                                    a.slideToClosest(a.params.speed, !0, void 0, w)
                                }, 0)
                            }
                            a.mousewheel.timeout || (a.mousewheel.timeout = b(function() {
        ...
        j = {
            ...
            onDragEnd: function(e) {
                var t = this,
                    ...
                    s = t.$wrapperEl,
                    r = i.$el;
                t.scrollbar.isTouched && (t.scrollbar.isTouched = !1, t.params.cssMode && (t.$wrapperEl.css("scroll-snap-type", ""), s.transition("")), a.hide && (clearTimeout(t.scrollbar.dragTimeout), t.scrollbar.dragTimeout = b(function() {
        ...
        U = {
            ...
            onGestureChange: function(e) {
                ...
                if (!a.gestures) {
                    ...
                    s.fakeGestureMoved = !0, r.scaleMove = U.getDistanceBetweenTouches(e)
                }
        ...
        J = {
            ...
            init: function() {
                ...
                e.a11y.addElId(n, l), i = e.params.autoplay && e.params.autoplay.enabled ? "off" : "polite", e.a11y.addElLive(n, i), t.itemRoleDescriptionMessage && e.a11y.addElRoleDescription(f(e.slides), t.itemRoleDescriptionMessage), e.a11y.addElRole(f(e.slides), "group"), e.slides.each(function(t) {
                    var a = f(t);
        ...
        Q = {
            init: function() {
                ...
                if (e.params.history) {
                    ...
                    var a = e.history;
                    a.initialized = !0, a.paths = Q.getPathValues(e.params.url), (a.paths.key || a.paths.value) && (a.scrollToSlide(0, a.paths.value, e.params.runCallbacksOnInit), e.params.history.replaceState || t.addEventListener("popstate", e.history.setHistoryPopState))
                }
            },
            destroy: function() {
                var e = l();
            ...
            setHistory: function(e, t) {
                ...
                if (a.history.initialized && a.params.history.enabled) {
                    ...
                    var r = a.slides.eq(t),
                        n = Q.slugify(r.attr("data-history"));
        ...
        te = {
            run: function() {
                ...
                t.attr("data-swiper-autoplay") && (a = t.attr("data-swiper-autoplay") || e.params.autoplay.delay), clearTimeout(e.autoplay.timeout), e.autoplay.timeout = b(function() {
                    var t;
        ...
        ie = {
            setTranslate: function() {
                ...
                for (var v = 0; v < s.length; v += 1) {
                    ...
                    if (b <= 1 && b > -1 && (h = 90 * g + 90 * b, l && (h = 90 * -g - 90 * b)), m.transform(C), p.slideShadows) {
                        ...
                        0 === S.length && (S = f('<div class="swiper-slide-shadow-' + (u ? "left" : "top") + '"></div>'), m.append(S)), 0 === M.length && (M = f('<div class="swiper-slide-shadow-' + (u ? "right" : "bottom") + '"></div>'), m.append(M)), S.length && (S[0].style.opacity = Math.max(-b, 0)), M.length && (M[0].style.opacity = Math.max(b, 0))
                    }
                }
                if (i.css({
